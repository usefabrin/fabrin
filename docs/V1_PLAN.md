...
| Sessions and transport (#112) | Native and browser login, CSRF, rotation, revocation, expiry, CORS and cleanup | Native bearer handlers and identity-wide logout implemented; browser transport and privilege revocation pending |
