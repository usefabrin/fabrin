...
| Sessions and transport (#112) | Native and browser login, CSRF, rotation, revocation, expiry, CORS and cleanup | Native bearer handlers implemented; browser transport and broad revocation pending |
