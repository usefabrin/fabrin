...
| Sessions and transport (#112) | Native and browser login, CSRF, rotation, revocation, expiry, CORS and cleanup | Native handlers, identity-wide logout and challenge context binding implemented; browser pre-auth transport and privilege revocation pending |
