...
| The migration autodetector (`django.db.migrations.autodetector`) | `migratediff` — schema differ plus SQLite/PostgreSQL DDL emitters, public since #59; nullability and index changes detected per [ADR 0006](adr/0006-field-constraint-semantics.md) | ✅ F2 |
